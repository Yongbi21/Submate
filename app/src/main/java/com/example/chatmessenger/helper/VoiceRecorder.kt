...
import com.example.chatmessenger.helper.VoiceRecorder.Callback
...
class VoiceRecorder(private val mCallback: Callback) {
    ...
    fun start(context: Context) {
        ...
        mAudioRecord = createAudioRecord(context)
     ...
     * permissions?).
     */
    private fun createAudioRecord(context: Context): AudioRecord? {
